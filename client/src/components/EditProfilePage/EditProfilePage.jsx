...
export default function Example() {
  ...
  const getIndUser = async () => {
    try {
      setIsLoading(true);
      const {data} = await axios.get(`https://jr-assist-api.vercel.app/api/users/getuser/${id}`);
      setInputs({
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const { data } = await axios.put(`https://jr-assist-api.vercel.app/api/users/update/${id}`, {
